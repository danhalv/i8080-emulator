...
void i8080_step(i8080_t *state) {
	...
	switch(*opcode) {
		...
		case 0x31:	i8080_lxi(state, (regpair_t){}, SP, opcode[1], opcode[2]);	break;	
		case 0x32:	i8080_sta(state, opcode[1], opcode[2]); 					break;	
		case 0x33:	i8080_inx(state, (regpair_t){}, SP);						break;	
		...
		case 0x3b:	i8080_dcx(state, (regpair_t){}, SP);						break;	
